const it_IT = {
  ...
  language_changed:
    'Lingua cambiata! - Necessario ricaricare la pagina per applicare le modifiche.',
  help_translate:
    "Non trovi la tua lingua? puoi dare una mano a tradurre quest'app seguendo la guida di traduzione su github.",
  reload: 'RICARICA',
  ...
  multiple_tabs_alert_notice_two:
    'Per favore evita di crittare/decrittare file in multiple schede contemporaneamente.',
  ...
  short_password:
    'Inserisci una password che abbia una lunghezza minima di 12 caratteri, oppure utilizza il generatore casuale.',
  wrong_public_key: 'Chiave pubblica errata',
  wrong_private_key: 'Chiave privata errata',
  invalid_keys_input: 'Input chiave non valido.',
  invalid_key_pair:
    'Questa coppia di chiavi non è valida! Per favore scegli le chiavi per parti differenti.',
  ...
  offline_note:
    'I file non sono caricati su alcun server, tutto viene svolto offline nel tuo browser.',
  ...
  after_enc_note_one:
    'Devi condividere questo file assieme alla tua chiave pubblica per permettere al destinatario di decriptarlo.',
  after_enc_note_two:
    'Puoi creare un link contenente la tua chiave pubblica così da non doverti preoccupare di comunicarla al destinatario.',
  ...
  sender_key_loaded:
    'La chiave pubblica del mittente è caricata, ora scegli il file crittografato.',
  recipient_key_loaded:
    'La chiave pubblica del destinatario è caricata, ora scegli un file da crittografare',
  file_not_encrypted_corrupted:
    'Questo file non è stato crittografato con hat.sh o potrebbe essere corrotto!',
  old_version:
    "Questo file è stato crittografato usando una vecchia versione di hat.sh, puoi decrittografarlo visitando l'app v1.",
  file_mixup:
    'I file seezionati per la decrittografia devono essere cifrati usando lo stesso metodo, tramite password oppure chiave pubblica. Scegli file che soddisfino questo requisito.',
  ...
  file_has_wrong_password:
    'la password è sbagliata, il test password è stato interrotto. Assicurati che tutti i file utilizzino la stessa password di decrittografia.',
  file_has_wrong_keys:
    'le chiavi sono sbagliate, il test delle chiavi è stato interrotto. Assicurati che tutti i file utilizzino la stessa chiave di decrittografia.',
  ...
  limited_private:
    "Hai una esperienza d'uso limitata (file singoli, 1GB) a causa della navigazione privata.",
  ...
  private_key_notice:
    'Non condividere MAI la tua chiave privata! Solo le chiavi pubbliche dovrebbero essere scambiate.',
  generate_qr_code: 'Genera codice QR',
  qr_code_note_one:
    "Questo codice QR contiene la tua chiave pubblica. Dopo la scansione, il dispositivo ti reindirizzera all'app e compilerà la chiave pubblica in automatico.",
  qr_code_note_two:
    'Puoi condividere questo codice QR o link con gli altri, invece di farli inserire manualmente la tua chiave pubblica quando criptano i file.',
