const cs_CS = {
  ...
  help_translate:
    'Nemůžete najít svůj jazyk? Můžete pomoci s překladem aplikace dle instrukcí na githubu.',
  reload: 'NAČÍST ZNOVA',
  ...
  multiple_tabs_alert_notice_two:
    'Prosím, vyhněte se šifrování/dešifrování souborů v různých kartách najednou.',
  understand: 'ROZUMÍM',
  ...
  file_mixup:
    'Vybrané soubory pro dešifrování musí být zašifrovány stejnou metodou, heslem nebo veřejným klíčem. Vyberte odpovídající soubory.',
  ...
  file_has_wrong_password:
    'má špatné heslo, test hesel byl zastaven. Ujištěte se, že všechny soubory mají stejné správné heslo pro dešifrování.',
  file_has_wrong_keys:
    'má špatné klíče, test klíčů byl přerušen. Ujištěte se, že všechny soubory mají stejné správné klíče pro dešifrování.',
  ...
  qr_code_note_one:
    'Tento QR kód obsahuje Váš veřejný klíč. Po jeho naskenování naše aplikace automaticky klíč načte.',
  qr_code_note_two:
    'S tímto QR kódem nebudou ostatní muset při šifrování ručně vkládat Váš veřejny klíč.',
