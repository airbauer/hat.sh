                  ...
                  InputProps={{
                    ...
                    endAdornment: PublicKey && (
                      <>
                        ...
                        <Tooltip title={t('download_public_key')} placement="bottom">
                          <IconButton onClick={() => downloadKey(PublicKey, 'key.public')}>
                            <GetAppIcon />
                          </IconButton>
                        </Tooltip>
                      </>
                  ...
                  InputProps={{
                    ...
                    endAdornment: PrivateKey && (
                      <>
                        ...
                        <Tooltip title={t('download_private_key')} placement="bottom">
                          <IconButton onClick={() => downloadKey(PrivateKey, 'key.private')}>
                            <GetAppIcon />
                          </IconButton>
                        </Tooltip>
                      </>
