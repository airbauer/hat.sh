const tr_TR = {
  ...
  help_translate:
    "Dilinizi bulamıyor musunuz? Github'daki çeviri kılavuzunu takip ederek bu uygulamayı çevirmeye yardımcı olabilirsiniz..",
  reload: 'YENİLE',
  dark_mode: 'Koyu Mod',
  close: 'Kapat',
  reset: 'Sıfırla',
  ...
  multiple_tabs_alert_notice_two:
    'Lütfen aynı anda farklı sekmelerdeki dosyaları şifrelemekten/şifresini çözmekten kaçının.',
  understand: 'ANLADIM',
  ...
  after_enc_note_one:
    ' Alıcının şifreyi çözmesi için bu dosyayı açık anahtarınızla birlikte paylaşmalısınız.',
  after_enc_note_two:
    'Açık anahtarınıza sahip bir bağlantı oluşturabilirsiniz, böylece açık anahtarınızı göndermek ve alıcının girmesi konusunda endişelenmenize gerek kalmaz.',
  ...
  file_not_encrypted_corrupted:
    'Bu dosya hat.sh kullanılarak şifrelenmemiş veya dosya bozulmuş olabilir!',
  old_version:
    "Bu dosya, hat.sh'nin eski bir sürümü kullanılarak şifrelenmiş, v1 uygulamasını ziyaret ederek bu dosyanın şifresini çözebilirsiniz.",
  file_mixup:
    'Şifre çözme için seçilen dosyalar, parola veya açık anahtar ile aynı yöntem kullanılarak şifrelenmelidir. Eşleşen dosyaları seçin.',
  ...
  file_has_wrong_password:
    'parola yanlış, parola denemesi durduruldu, tüm dosyaların aynı doğru şifre çözme parolasına sahip olduğundan emin olun.',
  file_has_wrong_keys:
    ' yanlış anahtar, anahtar denemesi durduruldu, tüm dosyaların aynı doğru şifre çözme anahtarlarına sahip olduğundan emin olun.',
  ...
  private_key_notice:
    'Özel anahtarınızı asla kimseyle paylaşmayın! Yalnızca açık anahtarlar paylaşılmalıdır.',
  generate_qr_code: 'QR kod üret',
  qr_code_note_one:
    'Bu QR kod sizin açık anahtarınızı içerir. Taramadan sonra cihaz uygulamaya yönlendirilecek ve açık anahtarınız otomatik olarak dolduracaktır.',
  qr_code_note_two:
    ' Dosyaları şifrelerken açık anahtarınızı elle girmek zorunda kalmak yerine, bu QR kodunu veya bağlantıyı başkalarıyla paylaşabilirsiniz.',
