const es_ES = {
  ...
  help_translate:
    '¿No encuentras tu idioma? Puedes ayudar a traducir esta aplicación siguiendo la guía de traducción en github.',
  reload: 'RECARGAR',
  ...
  multiple_tabs_alert_notice_two:
    'Por favor, evita cifrar/descifrar archivos en diferentes pestañas al mismo tiempo.',
  understand: 'ENTIENDO',
  ...
  short_password:
    'Por favor, introduzce una contraseña con una longitud mínima de 12 caracteres. O genera una.',
  ...
  invalid_key_pair:
    '¡Este par de claves no es inválido! Por favor, select keys for different parties.',
  ready_to_download: '¡se ha cargado con éxito y está listo para descargarse!',
  files_ready_to_download:
    '¡Los archivos se han cargado con éxito y están listos para ser descargados!',
  ...
  offline_note:
    'Los archivos no se suben a un servidor, todo se hace sin conexión en su navegador.',
  ...
  after_enc_note_one:
    'Debes compartir este archivo junto con tu clave pública para que el destinatario pueda descifrarlo.',
  after_enc_note_two:
    'Puedes crear un enlace que tenga tu clave pública para no tener que enviarla y preocuparte de que el destinatario la introduzca.',
  ...
  sender_key_loaded:
    'La clave pública del remitente está cargada, por favor selecciona el archivo cifrado.',
  recipient_key_loaded:
    'La clave pública del destinatario está cargada, por favor selecciona un archivo para cifrar.',
  file_not_encrypted_corrupted:
    '¡Este archivo no fue cifrado usando hat.sh o el archivo puede estar corrupto!',
  old_version:
    'Este archivo fue cifrado utilizando una versión más antigua de hat.sh, puedes descifrar este archivo visitando la aplicación v1',
  file_mixup:
    'Los archivos seleccionados para el descifrado tienen que estar cifrados con el mismo método, ya sea mediante contraseña o clave pública. Elige los archivos que coincidan.',
  ...
  file_has_wrong_password:
    'tiene una contraseña incorrecta, se detuvo la comprobación de contraseña, asegúrate de que todos los archivos tienen la misma contraseña correcta de descifrado.',
  file_has_wrong_keys:
    'tiene claves incorrectas, se detuvo la comprobación de claves , asegúrese de que todos los archivos tienen las mismas claves correctas de descifrado.',
  ...
  limited_private:
    'Tienes una experiencia limitada (un solo archivo, 1GB) debido a la navegación privada.',
  ...
  private_key_notice:
    '¡Nunca compartas tu clave privada con nadie! Sólo se deben intercambiar las claves públicas.',
  generate_qr_code: 'Generar código QR',
  qr_code_note_one:
    'Este código QR contiene tu clave pública. Una vez escaneado, el dispositivo se redirigirá a la aplicación y rellenará automáticamente la clave pública.',
  qr_code_note_two:
    'Puedes compartir este código QR o enlace con otras personas, en lugar de que tengan que introducir manualmente tu clave pública al cifrar los archivos.',
